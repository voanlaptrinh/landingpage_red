@if (!empty($landingPage->title == 'block08') & ($landingPage->title == 'block08'))
    <section
        class="elementor-section elementor-top-section elementor-element elementor-element-1a03561a elementor-section-boxed elementor-section-height-default elementor-section-height-default"
        data-id="1a03561a" data-element_type="section">
        <div class="elementor-background-overlay"></div>
        <div class="elementor-container elementor-column-gap-default">
            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-59443d36"
                data-id="59443d36" data-element_type="column">
                <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-1713998 elementor-widget elementor-widget-jkit_animated_text"
                        data-id="1713998" data-element_type="widget" data-widget_type="jkit_animated_text.default">
                        <div class="elementor-widget-container">
                            <div class="jeg-elementor-kit jkit-animated-text jeg_module_125_31_66699f110b0b6"
                                data-style="none">
                    ...
                    <div class="elementor-element elementor-element-567b9c68 elementor-widget elementor-widget-heading"
                        data-id="567b9c68" data-element_type="widget" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                            <h2 class="elementor-heading-title elementor-size-default">{{ $landingPage->block->title1 }}
                            </h2>
                        </div>
                    </div>
                    <div class="elementor-element elementor-element-a778d3a elementor-widget elementor-widget-text-editor"
                        data-id="a778d3a" data-element_type="widget" data-widget_type="text-editor.default">
                        <div class="elementor-widget-container">
                            <p>{{ $landingPage->block->description }}</p>
                        </div>
                    </div>
                    <div class="elementor-element elementor-element-98e61da elementor-widget elementor-widget-jkit_post_block"
                        data-id="98e61da" data-element_type="widget" data-widget_type="jkit_post_block.default">
                        <div class="elementor-widget-container">
                            <div class="jeg-elementor-kit jkit-postblock postblock-type-3 jkit-pagination-disable post-element jeg_module_125_32_66699f111a16d"
                                data-id="jeg_module_125_32_66699f111a16d"
                                            ...
                                            <article
                                                ...
                                                <div class="jkit-thumb"><a href="">
                                                    ...
                                                    <div class="jkit-post-category position-left"><span><a
                                                                ...
                                                                class="category-project">{{$new->category}}</a></span></div>
                                                </div>
