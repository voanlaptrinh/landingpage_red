...
<div class="col-lg-12 pt-3">
        ...
        @foreach ($block->json as $index => $item)
            <div class="field-group3 mb-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <button type="button" class="btn btn-danger firemove-field3">Xóa</button>
                    </div>
                </div>
            </div>
        @endforeach
    ...
    <div class="text-center">
        ...
        <button type="button" id="add-field3" class="btn btn-secondary mb-3">Thêm các lĩnh vực</button>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $('#add-field3').click(function() {
            ...
            `;
            $('#fields-container3').append(fieldHtml);
        });

        $(document).on('click', '.firemove-field3', function() {
