        ...
        @foreach ($block->json as $index => $item)
            <div class="field-group mb-3">
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" name="json[{{ $index }}][link]" class="form-control"
                            placeholder="Value" value="{{ $item['link'] }}" required>
                    </div>
                    <div class="col-auto">
            ...
            let fieldHtml = `
                <div class="field-group mb-3">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" name="json[${fieldIndex}][link]" class="form-control" placeholder="link" required>
                        </div>
                        <div class="col-auto">
                            <button type="button" class="btn btn-danger remove-field">Xóa</button>
                        </div>
