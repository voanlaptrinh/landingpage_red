                            ...
                            <div class="file-upload-form">
                                ...
                                <label for="file" class="file-upload-label">
                                    <div class="file-upload-design">
                                        @if ($newsItem->images)
                                            <div class="mb-3">
                                                <img width="137px" src="{{ asset('images/' . $newsItem->images) }}"
                                                    alt="Current Image" style="max-width: 100%;" id="upload-icon">
                                                <img width="137px" src=""
                                                    alt="Current Image" style="max-width: 100%;display: none" id="demo-image-preview" >
                                            </div>
                                        @else
                                        ...
                                        <img src="" id="demo-image-preview" alt=""  width="50px" style="display: none">
                                            <p>Drag and Drop</p>
                                            <p>or</p>
