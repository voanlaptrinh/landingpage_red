            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        <img style="width: 100px; height: 100px;" src="{{ asset('images/' . $subcriptionItem->images) }}"
                            style="" alt="Profile" class="rounded-circle">
                        <h2>{{ $subcriptionItem->title }}</h2>
                        <h6>Giá: {{ $subcriptionItem->price }} VNĐ</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-8">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview" role="tabpanel">
                                ...
                                <p class="small fst-italic">{{ $subcriptionItem->description }}</p>
                            </div>
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit" role="tabpanel">
                                <div class="container content-detail-newssubcription">
                                    {!! $subcriptionItem->content !!}
                                </div>
                            </div>
                        </div>
                    </div>
