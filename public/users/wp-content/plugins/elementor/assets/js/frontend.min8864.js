                    ...
                    changeVideoSize() {
                        ...
                        if (
                            ("youtube" === this.videoType ?
                                ...
                                (e = this.elements.$backgroundVideoHosted), !e)
                        )
                            return;
            ...
            class Shapes extends elementorModules.frontend.handlers.Base {
                ...
                getSvgURL(e, t) {
                    ...
                    return (
                        ...
                        ((n = elementor.config.additional_shapes[e]), -1 < t.indexOf("-negative") &&
                ...
                setNegative(e) {
                    this.elements["$" + e + "Container"].attr(
                        "data-negative", !!this.getElementSettings(
                ...
                onInit() {
                    this.isActive(this.getSettings()) &&
                        (super.onInit(...arguments), ["top", "bottom"].forEach((e) => {
                    ...
                    if (
                        ...
                        if (t.length) {
                            ...
                            r.length > 0 && (s -= r.height()),
                                ...
                                this.elements.$scrollable.animate({ scrollTop: s },
        ...
        4375: (e, t) => {
            ...
            class Breakpoints extends elementorModules.Module {
                ...
                getActiveBreakpointsList() {
                    ...
                    if (e.withDesktop) {
                        const e = -1 === t.indexOf("widescreen") ?
                            t.length :
                            t.length - 1;
                    ...
                    if (a) {
                        ...
                        a.push(r),
                            (a = (function _hookInsertSort(e) {
                                for (
                                    var t, n, o, i = 1, s = e.length; i < s; i++
                                ) {
                                    for (
                                        t = e[i], n = i;
                                        (o = e[n - 1]) &&
